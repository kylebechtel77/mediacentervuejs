...
export default new Vuex.Store({
  state: {
    ...
    allDay: [{ text: 'All Day' }],
    periods: [{ text: '1st Period' }, { text: '2nd Period' }, { text: '3rd Period' },
      { text: '4th Period' }, { text: '5th Period' }, { text: '6th Period' }],
    timeSlots: [{ text: '9:15', name: 'kyle' }, { text: '9:30' }, { text: '9:45' },
    ...
    labItems: [
      { id: 'lab502', text: 'Labs 502', times: this.periods },
      { id: 'lab504', text: 'Labs 504', times: this.periods },
      { id: 'lab705', text: 'Labs 705', times: this.periods },
      { id: 'labcart1', text: 'Lab Cart 1 (30)', times: this.allDay },
      { id: 'labcart2', text: 'Lab Cart 2 (18)', times: this.allDay },
    ],
    libraryItems: [
      { id: 'mediacenter', text: 'Media Center', times: this.timeSlots },
      { id: 'greenscreen', text: 'Green Screen', times: this.periods },
    ],
  },
  getters: {
  },
